        ...
        implements TracerProvider
{
    ...
    public static final Function<Map<String, String>, TracerHandle> NOOP_HANDLE_GENERATOR = new Function<Map<String, String>, TracerHandle>()
    {
        @Override
        public TracerHandle apply(Map<String, String> headers)
        {
            return NOOP_TRACER_HANDLE;
        }
    };
