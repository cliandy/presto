...
import static com.facebook.presto.spi.StandardErrorCode.TRACER_PROVIDER_ERROR;
...
public class TracerProviderManager
{
    ...
    public TracerProvider getTracerProvider()
    {
        ...
        throw new PrestoException(
                TRACER_PROVIDER_ERROR,
                "Tracer provider was not properly set before method invocation.");
    }
}
